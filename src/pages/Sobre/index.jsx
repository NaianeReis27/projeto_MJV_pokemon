...
O grupo determinou, por meio de votação, a escolha da API de Pokémon e logo em seguida foi gestado uma ideia inicial de UI design pelo Figma. Após os primeiros encontros, cada pessoa do grupo optou por escolha própria qual parte deveria ser trabalhada. </p>
<div>
...
<p>Agradecimentos especiais à toda equipe da <a href="https://www.mjvinnovation.com/pt-br/">MJV</a> que proporcionou as aulas de React, disponibilizou material, foram prestativos e nos deu essa oportunidade incrível de aprender com o <a href="https://www.instagram.com/tsu.node/">Gabriel Tsunoda</a>, professor maravilhoso com didática excelente! </p>

<p>Este site é o produto final do processo, esperamos que gostem ❤️</p>

<p>aqui vocês podem conferir o <a href="https://www.figma.com/file/Vcv7pq7IhSN2fsu5OCBEo1/Pokedex---REACT?node-id=38%3A399&t=DgqOabTjOHAwo64b-1"> Figma</a>.
aqui vocês podem conferir o projeto na íntegra pelo <a href="">Github</a> . </p>
            <Imagem />
